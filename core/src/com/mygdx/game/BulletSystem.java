...
//
//                for(Entity en : collisionEntities) {
//                    System.out.println("+++++++");
//                    System.out.println(en.getComponents());
//                    System.out.println("+++++++");
//                }

                enemyCheckLoop:
                for(Entity enemy : collisionEntities){
                    CollisionComponent enemyCollisionComponent = (CollisionComponent) enemy.getComponents().get(enemy.getComponents().size() - 2);
